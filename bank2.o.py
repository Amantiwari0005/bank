...
def ab():
    ...
    Label(aman50,text="").pack()
    Label(aman50,text="Made in KV Kunjaban Agartala",fg="blue",font=("Gabriola",12,"bold")).pack()
    ...
    Label(aman50,text="Aman (Coder & Student[KVS])",fg="Dark red",font=("Gabriola",12,"bold")).pack(anchor="nw")
    Label(aman50,text="Ayush (Coder & Student[KVS])",fg="Dark red",font=("Gabriola",12,"bold")).pack(anchor="nw")
    Label(aman50,text="Rollick (Coder & Student[KVS])",fg="Dark red",font=("Gabriola",12,"bold")).pack(anchor="nw")
    Label(aman50,text="Adity (Coder & Student[KVS])",fg="Dark red",font=("Gabriola",12,"bold")).pack(anchor="nw")
